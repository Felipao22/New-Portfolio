...
//               <p className="mb-6">
//                 I'm a passionate Frontend Developer with expertise in creating modern, responsive, and user-centered web applications.
//                 With a strong foundation in JavaScript, React, and modern CSS frameworks, I bring ideas to life through clean code and thoughtful design.
//               </p>
//               <p className="mb-6">
//                 My approach combines technical excellence with creative problem-solving, ensuring that every project not only looks great
//                 but also provides an exceptional user experience across all devices and platforms.
//               </p>
//               <p>
//                 I stay current with the latest technologies and best practices in web development, continuously learning and adapting
//                 to deliver cutting-edge solutions that meet both user needs and business objectives.
//               </p>
//             </div>
//           </div>
